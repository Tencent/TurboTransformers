...
#include "easy_transformers/core/profiler.h"
#include "easy_transformers/core/tensor.h"
#include "easy_transformers/layers/bert_attention.h"
#include "easy_transformers/layers/bert_embedding.h"
#include "easy_transformers/layers/bert_intermediate.h"
#include "easy_transformers/layers/bert_output.h"
#include "easy_transformers/layers/prepare_bert_masks.h"
#include "easy_transformers/layers/sequence_pool.h"
#include "loguru.hpp"
...
PYBIND11_MODULE(easy_transformers_cxx, m) {
  char *argv[] = {strdup("easy_transformers_cxx"), nullptr};
  int argc = 1;
  loguru::init(argc, argv);

  auto config_module =
      m.def_submodule("config", "compile configuration of easy_transformers");
