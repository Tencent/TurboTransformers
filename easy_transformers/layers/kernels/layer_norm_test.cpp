...
#include "easy_transformers/layers/kernels/layer_norm.h"
...
TEST_CASE("layer_norm CPU and GPU correctness") {
  ...
  for (auto batch_size : batch_size_list)
    for (auto seq_length : seq_length_list) {
      easy_transformers::core::Tensor gpu_gamma(
          easy_transformers::core::NewDLPackTensorT<float>({hidden_size},
                                                           kDLGPU, 0));

      easy_transformers::core::Tensor cpu_gamma(
          easy_transformers::core::NewDLPackTensorT<float>({hidden_size},
                                                           kDLCPU, 0));

      easy_transformers::core::Tensor gpu_beta(
          easy_transformers::core::NewDLPackTensorT<float>({hidden_size},
                                                           kDLGPU, 0));

      easy_transformers::core::Tensor cpu_beta(
          easy_transformers::core::NewDLPackTensorT<float>({hidden_size},
                                                           kDLCPU, 0));

      easy_transformers::core::Tensor gpu_out(
          easy_transformers::core::NewDLPackTensorT<float>(
              {batch_size, seq_length, hidden_size}, kDLGPU, 0));

      easy_transformers::core::Tensor cpu_out(
          easy_transformers::core::NewDLPackTensorT<float>(
              {batch_size, seq_length, hidden_size}, kDLCPU, 0));

      ::easy_transformers::test::FillDataForCPUGPUTensors<float>(cpu_gamma,
                                                                 gpu_gamma);
      ::easy_transformers::test::FillDataForCPUGPUTensors<float>(cpu_beta,
                                                                 gpu_beta);
...
TEST_CASE("add_bias_layer_norm CPU and GPU correctness") {
  ...
  for (auto batch_size : batch_size_list)
    for (auto seq_length : seq_length_list) {
      easy_transformers::core::Tensor gpu_input(
          easy_transformers::core::NewDLPackTensorT<float>(
              {batch_size, seq_length, hidden_size}, kDLGPU, 0));
      easy_transformers::core::Tensor cpu_input(
          easy_transformers::core::NewDLPackTensorT<float>(
              {batch_size, seq_length, hidden_size}, kDLCPU, 0));

      easy_transformers::core::Tensor gpu_bias(
          easy_transformers::core::NewDLPackTensorT<float>({hidden_size},
                                                           kDLGPU, 0));
      easy_transformers::core::Tensor cpu_bias(
          easy_transformers::core::NewDLPackTensorT<float>({hidden_size},
                                                           kDLCPU, 0));
      ...
      ::easy_transformers::test::FillDataForCPUGPUTensors<float>(cpu_input,
                                                                 gpu_input);
      ...
      auto& cuda_ctx =
          easy_transformers::core::CUDADeviceContext::GetInstance();
