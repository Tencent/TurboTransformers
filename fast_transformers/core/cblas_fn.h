...
cblas_sgemm_batch(CBLAS_LAYOUT Layout, CBLAS_TRANSPOSE *transa_array,
                  ...
                  BlasInt *n_array, BlasInt *k_array, const float *alpha_array,
                  const float **a_array, BlasInt *lda_array, const float **b_array,
                  BlasInt *ldb_array, const float *beta_array, float **c_array,
