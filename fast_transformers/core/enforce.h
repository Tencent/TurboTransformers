...
#define FT_THROW(...)                                        \
  do {                                                       \
    throw ::fast_transformers::core::details::EnforceNotMet( \
...
#define FT_ENFORCE_CUDA_SUCCESS(COND, ...)                                   \
  do {                                                                       \
    ...
    constexpr auto __success_type__ =                                        \
        ::fast_transformers::core::details::CUDAStatusTrait<                 \
            __CUDA_STATUS_TYPE__>::kSuccess;                                 \
    if (FT_UNLIKELY(__cond__ != __success_type__)) {                         \
      std::string error_msg =                                                \
          std::string("[FT_ERROR] CUDA runtime error: ") +                   \
          ::fast_transformers::core::details::CUDAGetErrorString(__cond__) + \
