...
template void thrust_sequence<int64_t>(int64_t* data_ptr, int64_t size);
template void thrust_sequence<float>(float* data_ptr, int64_t size);
...
template void thrust_fill<int64_t>(int64_t* data_ptr, int64_t size,
                                   int64_t val);
template void thrust_fill<float>(float* data_ptr, int64_t size, float val);
...
void thrust_transform(int64_t* src_data_ptr, float* dst_data_ptr,
                      const int64_t size) {
